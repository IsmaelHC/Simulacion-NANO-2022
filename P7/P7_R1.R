...
library(stargazer)
sumatorias=data.frame(grupal_1,grupal_2)
#stargazer(sumatorias, type="latex",summary.stat = c("n","mean", "min","max"),digits = 5)
velocidad=data.frame(arrive_1,arrive_2)
stargazer(velocidad, type="latex",summary.stat = c("n","mean", "min","max"),digits = 5)
wilcox.test(grupal_1,grupal_2)
wilcox.test(arrive_1,arrive_2)
